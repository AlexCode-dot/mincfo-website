...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "visual",
      fields: [
        { name: "signal", title: "Signaltext", type: "string" },
        { name: "chartLabel", title: "Diagrametikett", type: "string" },
        {
          name: "stats",
          title: "Statistik",
          type: "array",
    ...
    defineField({
      ...
      group: "visual",
      fields: [
        { name: "chipOwnership", title: "Chip: Ägarskap", type: "string" },
        { name: "chipDelivery", title: "Chip: Leverans", type: "string" },
        { name: "chipLeadership", title: "Chip: Ledarskap", type: "string" },
    ...
    defineField({
      name: "scenarioUi",
      title: "Scenario UI (lösningssidor)",
      type: "object",
      group: "visual",
      fields: [
        defineField({ name: "typingStatus", title: "Skrivstatus", type: "string" }),
        defineField({ name: "analyzingStatus", title: "Analyseringsstatus", type: "string" }),
        defineField({ name: "readyStatus", title: "Klar-status", type: "string" }),
        defineField({ name: "copilotLabel", title: "Copilot-etikett", type: "string" }),
        defineField({ name: "copilotResponseLabel", title: "Copilot-svar", type: "string" }),
        defineField({ name: "metaLoadingLabel", title: "Laddar-etikett", type: "string" }),
        defineField({ name: "metaReadyLabel", title: "Klar-etikett", type: "string" }),
        defineField({ name: "boardTitle", title: "Tavla-rubrik", type: "string" }),
        defineField({ name: "boardBadge", title: "Tavla-badge", type: "string" }),
        defineField({ name: "chartComparisonLabel", title: "Diagramjämförelse", type: "string" }),
        defineField({ name: "legendBase", title: "Bas", type: "string" }),
        defineField({ name: "legendScenario", title: "Scenario", type: "string" }),
        defineField({ name: "startLabel", title: "Start-etikett", type: "string" }),
        defineField({ name: "waitingLabel", title: "Väntar-etikett", type: "string" }),
        defineField({ name: "disclaimer", title: "Ansvarsfriskrivning", type: "string" }),
      ],
    }),

    // ── Solution Shared CTAs ──
    defineField({
      name: "solutionSharedCtas",
      title: "Lösningssidor - Gemensamma texter",
      type: "object",
      group: "visual",
      fields: [
        defineField({ name: "heroPrimaryCta", title: "Primär CTA", type: "string" }),
        defineField({ name: "heroSecondaryCta", title: "Sekundär CTA", type: "string" }),
        defineField({ name: "helpsOverline", title: "Lösningsöversyn", type: "string" }),
        defineField({ name: "impactTag", title: "Affärsvärde-tagg", type: "string" }),
        defineField({ name: "closingOverline", title: "Avslut-ögonbryn", type: "string" }),
        defineField({ name: "closingAccent", title: "Avslut-accent", type: "string" }),
        defineField({ name: "closingCta", title: "Avslut-CTA", type: "string" }),
        defineField({ name: "indexTitle", title: "Indexsida - Rubrik", type: "string" }),
        defineField({ name: "indexDescription", title: "Indexsida - Beskrivning", type: "string" }),
      ],
    }),
  ],
